          ...
          <el-menu-item-group>
            ...
            <template #default="dd">
              ...
              >
                ...
                <span class="track" @click="tracking(car.position)">跟踪</span>
              </el-menu-item>
            </template>
          </el-menu-item-group>
...
export default defineComponent({
  ...
  setup(props, contxt) {
    ...
    let maker: any, isOutTracking = ref(false)
      , outVc: Function
    return {
      isCollapse: true,
      isOutTracking,
...
button.el-button.el-button--primary.el-button--small.is-round.outTracking {
  position: absolute;
  top: 8vh;
  left: 5vw;
}
